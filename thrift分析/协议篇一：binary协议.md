...
```
----------------------------------------------------
| 4字节方法名长度 | 方法名字串 |1字节消息类型| 4字节序列ID |
----------------------------------------------------
```
...
```
---------------------------------------
| 1字节参数类型 | 2字节字段顺序号 |参数内容 |
---------------------------------------
```

**1字节参数类型**：参数类型值，分bool=2、byte=3、i8=3、i16=6、i32=8、i64=10、double=4、map=13、list=15、set=14、struct=12、string=11等  
...
```
------------------------------------------------------
| 1字节key类型 | 1字节value类型 | 4字节mapsize | map内容 |
------------------------------------------------------
```
